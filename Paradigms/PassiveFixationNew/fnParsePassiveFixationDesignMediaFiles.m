...
if isfield(strctXML,'BlockOrder')
    ...
    for iOrderIter=1:iNumDifferentOrders 
        ...
        aiBlockConstrainNumImages= zeros(1,iNumBlockOrder);
        for iBlockOrderIter=1:iNumBlockOrder
            ...
            if isfield(strctXML.BlockOrder.Order{iOrderIter}.Block{iBlockOrderIter},'ConstrainImagesPerBlock')
                iNumConstrainedImages = str2num(strctXML.BlockOrder.Order{iOrderIter}.Block{iBlockOrderIter}.ConstrainImagesPerBlock);
            else
                iNumConstrainedImages = 0;
            end            
            
            aiBlockConstrainNumImages(iBlockOrderIter) = iNumConstrainedImages;
        ...
        strctDesign.m_strctBlocksAndOrder.m_astrctBlockOrder(iOrderIter).m_aiBlockConstrainNumImages = aiBlockConstrainNumImages;
    end
else
    ...
    strctDesign.m_strctBlocksAndOrder.m_astrctBlockOrder(1).m_aiBlockConstrainNumImages= 0;
