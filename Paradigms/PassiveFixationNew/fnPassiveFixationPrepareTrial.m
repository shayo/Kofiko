...
elseif ismember('microstim',lower(g_strctParadigm.m_strctDesign.m_astrctMedia(iNewStimulusIndex).m_acAttributes))
        strctMicroStim.m_bStimulation = true;
...
% Constrain the number of images per block 
if g_strctParadigm.m_strctDesign.m_strctBlocksAndOrder.m_astrctBlockOrder(g_strctParadigm.m_iCurrentOrder).m_aiBlockConstrainNumImages( g_strctParadigm.m_iCurrentBlockIndexInOrderList) > 0
    iNumMediaInBlock = min(length(g_strctParadigm.m_strctDesign.m_strctBlocksAndOrder.m_astrctBlocks(iSelectedBlock).m_aiMedia), g_strctParadigm.m_strctDesign.m_strctBlocksAndOrder.m_astrctBlockOrder(g_strctParadigm.m_iCurrentOrder).m_aiBlockConstrainNumImages( g_strctParadigm.m_iCurrentBlockIndexInOrderList));
else
