...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctTimingControllers.m_hPanel,40+30*3, ...
    'Retain Choice (ms):', 'RetainSelectedChoicePeriodMS', 0, 100, [1, 5], fnTsGetVar(g_strctParadigm,'RetainSelectedChoicePeriodMS'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctTimingControllers.m_hPanel,40+30*4, ...
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctStimuliControllers.m_hPanel,40+30*3, ...
    'Fixation Spot radius (pix):', 'FixationSpotPix', 0, 100, [1, 5], fnTsGetVar(g_strctParadigm,'FixationSpotPix'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctStimuliControllers.m_hPanel,40+30*4, ...
    'Fixation Spot radius (pix):', 'FixationSpotPix', 0, 100, [1, 5], fnTsGetVar(g_strctParadigm,'FixationSpotPix'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctStimuliControllers.m_hPanel,40+30*5, ...
...
strctControllers.m_hSaturationLists = uicontrol('Style', 'listbox', 'String', a2cCharMatrix,...
    'Position', [10 iPanelHeight-450 strctStimuliControllers.m_iPanelWidth-15 100], 'parent',strctStimuliControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''SelectSaturations'');'],...
...
strctControllers.m_hColorLists = uicontrol('Style', 'listbox', 'String', colorCell,...
    'Position', [10 iPanelHeight-600 ,strctStimuliControllers.m_iPanelWidth-15 100], 'parent',strctStimuliControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''SelectColors'');'],...
    'value',max(1,g_strctParadigm.m_strctInitialValues.m_iInitial_IndexInColorList),'UIContextMenu',strctControllers.hColorListContextMenu, 'max', 16, 'min', 0);

strctControllers.m_hSetFixationsSpotDuringChoices = uicontrol('Parent',strctStimuliControllers.m_hPanel,'Style', 'checkbox', 'String', 'Fixation Spot During Choices','value',...
	g_strctParadigm.m_strctChoiceVars.m_bShowFixationSpot,...
    'Position', [5 iPanelHeight-710 130 80], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ChoiceFixationSpot'');']);
...
strctControllers.m_hSetFixationCueOverride = uicontrol('Parent',strctStimuliControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use Fixation As Cue','value',...
    ...
    'Position', [5 iPanelHeight-750 130 80], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UseFixationAsCue'');']);
...
strctControllers.m_hSetStimulusOverRide = uicontrol('Parent',strctStimuliControllers.m_hPanel,'Style', 'checkbox', 'String', 'OverRide Stimulus Control','value',...
    ...
    'Position', [5 iPanelHeight-790 130 80], 'Callback', [g_strctParadigm.m_strCallbacks,'(''OverRideStimulusControl'');']);
	
strctControllers.m_hSetChoicesLocationsWeightingOverride = uicontrol('Parent',strctStimuliControllers.m_hPanel,'Style', 'checkbox', 'String', 'Choice Location Prob Override','value',...
	g_strctParadigm.m_strctChoicesVars.m_bChoicesLocationsWeightingOverride,...
    'Position', [5 iPanelHeight-830 130 80], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ChoicesLocationsWeightingOverride'');']);
	
strctControllers.m_hSetCueHighlight = uicontrol('Parent',strctStimuliControllers.m_hPanel,'Style', 'checkbox', 'String', 'Highlight Cue','value',...
	g_strctParadigm.m_strctStimuliVars.m_bCueHighlight,...
    'Position', [5 iPanelHeight-870 130 80], 'Callback', [g_strctParadigm.m_strCallbacks,'(''HighlightCue'');']);

strctControllers.m_hSetShowCue = uicontrol('Parent',strctStimuliControllers.m_hPanel,'Style', 'checkbox', 'String', 'Display Cue','value',...
	g_strctParadigm.m_strctStimuliVars.m_bDisplayCue,...
    'Position', [5 iPanelHeight-910 130 80], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ShowCue'');']);
...
strctCurrentTrial.m_strctPostTrial.m_fInterTrialIntervalSec = 0;
...
strctCurrentTrial.m_strctPostTrial.m_fTrialTimeoutMS = 5000;	
	

	
strctControllers.m_hSetExtinguishNonSelectedChoices = uicontrol('Parent',strctStimuliControllers.m_hPanel,'Style', 'checkbox', 'String', 'Extinguish Non Selected Choice','value',...
