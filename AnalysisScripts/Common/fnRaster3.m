function [a2bRaster,aiPeriStimulusRangeMS] = fnRaster3(afTimestamps, afStimulusTime, iBeforeMS, iAfterMS, fResolution)
%
...
aiPeriStimulusRangeMS = iBeforeMS:fResolution:iAfterMS;
...
for iTrialIter=1:iNumTrials
    ...
    if ~isempty(aiSpikesInd)
        aiSpikeTimesBins = 1+floor( (afTimestamps(aiSpikesInd) - afStimulusTime(iTrialIter) -iBeforeMS/1e3)*1/fResolution*1e3);
