function ahSubPlots = fnDisplayPassiveFixation_v2(ahPanels,strctUnit)
hParent = ahPanels(1);
...
% colormap jet
% colorbar
% set(h9,'ytick',1:(length(strctUnit.m_acConditionNames)+1), 'YtickLabel',[strctUnit.m_acConditionNames,'Baseline'])
% set(h9,'xtick',1:length(strctUnit.m_acConditionNames)+1);%, 'XtickLabel',[strctUnit.m_acConditionNames,'Baseline'])
% title('Log10 p-value');
