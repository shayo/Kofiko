...
strSubject = 'Tyson';
strFolder = 'D:\Data\Doris\Behavior\Tyson\';
    ...
    for iDesignIter=1:iNumUniqueDesigns
        ...
        switch strctDesign.m_strDesignFileName
            ...
            case '\\touch\StimulusSet\IdentityMatching\IdentityMatchingDMS_Bert.xml'
              strctStat = fnAnalyzeIdentityMatchingTouchTrials(astrctSortedTrials, strctGeneralInfo, strctKofiko,strctDesign);
            case '\\Kofiko-23c\StimulusSet\Doris_IdentityMatching\IdentityMatchingDMS_SpidermanFaces_Category.xml'
                strctStat = fnAnalyzeIdentityMatchingTrinity(astrctSortedTrials, strctGeneralInfo, strctKofiko,strctDesign);
