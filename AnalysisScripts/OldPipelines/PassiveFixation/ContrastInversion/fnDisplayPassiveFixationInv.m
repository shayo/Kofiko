function ahSubPlots = fnDisplayPassiveFixationInv(ahPanels,strctUnit)
hParent = ahPanels(1);
...
plot(1:iNumCategories, sum(strctUnit.m_a2bStimulusCategory(strctUnit.m_aiStimulusIndexValid,:),1));
xlabel('Categories');
ylabel('Num Stimuli');
