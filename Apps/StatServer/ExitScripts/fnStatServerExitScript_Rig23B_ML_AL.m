function fnStatServerExitScript_Rig23B_ML_AL(strSession, strSubject)
...
strDestinationDataFolder = ['E:\Data\Doris\Electrophys\',strSubject,'\ML_AL_Project\',strDate,'\RAW\'];
%%
