function strctControllers = fnAddTextSliderEditComboSmall(strctControllers, iCurrLinePos, ...
...
eval(['strctControllers.',strSliderVar ,' = uicontrol(''Parent'',strctControllers.m_hPanel,''Style'', ''slider'',  ''Min'',fMinSlider,''Max'',fMaxSlider, ''value'',fInitialValue',...
    ...
    ',''Position'', [110 strctControllers.m_iPanelHeight-iCurrLinePos+5 strctControllers.m_iPanelWidth-165 20],''Callback'',''',g_strctParadigm.m_strCallbacks,'(''''', strVarName,'Slider'''');'');']);
...
eval(['strctControllers.',strEditVar ,' = fnMyUIControlEdit(''Parent'',strctControllers.m_hPanel,''Style'', ''edit'',''String'',num2str(fInitialValue)'...
    ',''Position'', [strctControllers.m_iPanelWidth-45 strctControllers.m_iPanelHeight-iCurrLinePos+5 40 20],''Callback'',''',g_strctParadigm.m_strCallbacks,'(''''', strVarName,'Edit'''');'');'])
